...
def match_winning_odds(args):
    ...
    wins_1 = 0.0
    wins_2 = 0.0
    return elo_sf.match_winning_prob(e1, rating_1,rating_2,wins_1,wins_2,match_total,k_factor)
...
def optimize_brier(params,args=(elo_df)):
    return elo_sf.calc_brier_and_elos(elo_df,params,ratings_dummy=False)
...
"""
params = [ 19.16990346,   0.82343016,   0.41224102,   0.62754046]

#Output data is the set level data (now with columns for player 1 winning chance and player 1 and 2 rating prior to game)
brier_score, output_data,ratings_dict = elo_sf.calc_brier_and_elos(elo_df,params,ratings_dummy=True)
